...
before_migrate = [
    "education.before_migrate.before_migrate_hook.backup_critical_data"
]

after_migrate = [
    "education.patches.Test.update_employee.execute",
    "erpnext.edi.doctype.testing_doctype.Patches.making_titles.execute"
    # "education.data.employeedata.import_employees",
    # "education.data.userdata.import_users"
]
